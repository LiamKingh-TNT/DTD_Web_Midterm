...
$(document).ready(function(){
    ...
    $('.pick_selection').hover(
        function(){
            $(this).find('.selected_beam').addClass('visible');
            $(this).find('.selected_beam').removeClass('hide');
        },
        function(){
            $(this).find('.selected_beam').removeClass('visible');
            $(this).find('.selected_beam').addClass('hide');
        }
    );
});
